...
public class condef {
	...
	final static byte INS_READ_BIN        = (byte)0xB0;         //读出二进制命令的INS值、、、、、、
	...
	final static byte INS_GET_BALANCE     = (byte)0x5C;         //得到余额命令的INS值 、、、、、
	...
	final static short SW_BALANCE_NOT_ENOUGH = (short)0x9502;      //余额不够	、、、、、、
